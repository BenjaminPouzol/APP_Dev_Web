    ...
    <div style="display:flex; flex-direction:column; gap:24px;">
        ...
        <section style="background:white; border:1.5px solid var(--gray-200); border-radius:var(--radius-lg); padding:28px;">
            ...
            <p style="color:var(--gray-700); line-height:1.75; margin-bottom:12px;">
                Les données collectées lors de l'inscription (nom, prénom, pseudo, email, date de naissance, ville)
                sont utilisées exclusivement pour le fonctionnement de la plateforme ShareTime.
            ...
            <p style="color:var(--gray-700); line-height:1.75;">
                ...
                de vos données. Pour exercer ces droits, contactez-nous via le
        ...
        <section style="background:white; border:1.5px solid var(--gray-200); border-radius:var(--radius-lg); padding:28px;">
            ...
            <p style="color:var(--gray-700); line-height:1.75;">
                ShareTime utilise uniquement des <strong>cookies de session</strong> strictement nécessaires
                au bon fonctionnement de l'authentification. Ces cookies sont marqués
                <code>HttpOnly</code> et <code>SameSite=Lax</code> pour votre sécurité.
                Aucun cookie publicitaire ou de traçage n'est utilisé.
            </p>
        </section>

        <section style="background:white; border:1.5px solid var(--gray-200); border-radius:var(--radius-lg); padding:28px;">
            <h2 style="color:var(--navy); margin-bottom:12px; font-size:1.15rem;">Propriété intellectuelle</h2>
            <p style="color:var(--gray-700); line-height:1.75;">
                L'ensemble des contenus présents sur ce site (textes, logos, charte graphique) sont la propriété
                exclusive de ShareTime. Toute reproduction, même partielle, est interdite sans autorisation écrite préalable.
            </p>
        </section>
        ...
        <section style="background:white; border:1.5px solid var(--gray-200); border-radius:var(--radius-lg); padding:28px;">
            ...
            <p style="color:var(--gray-700); line-height:1.75;">
                ShareTime est une plateforme de mise en relation. Les activités sont organisées et gérées
                par des particuliers. ShareTime ne peut être tenu responsable des événements organisés par
                ses membres, ni des dommages directs ou indirects liés à leur participation.
            </p>
        </section>
